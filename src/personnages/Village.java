...
public class Village {
	...
	public static void main(String[] args) {
		...
		/* Quand on ajoute la ligne suivante:
		 ...
		 *
		 * Cette erreur survient car on essaye d'accéder au 30e élément
		 * alors qu'il n'y en a que 29.
		 */
		
		// Création du chef lors de l'instanciation du village (contrainte supplémentaire imposée lors du TP1)
		 ...
		 * 
		 * 'gaulois' est null, car on accède au deuxième habitant du village
		 * alors que le village n'en dispose que d'un.
		 */
